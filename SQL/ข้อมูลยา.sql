...
CREATE TABLE IF NOT EXISTS drugs (
    ...
    drug_category ENUM('CHEMOTHERAPY', 'TARGETED_THERAPY', 'IMMUNOTHERAPY') NOT NULL DEFAULT 'CHEMOTHERAPY' COMMENT 'กลุ่มยา: CHEMOTHERAPY (ยาเคมีบำบัด), TARGETED_THERAPY (ยามุ่งเป้า), IMMUNOTHERAPY (ยากลุ่มภูมิคุ้มกันบำบัด)',
...
INSERT INTO drugs 
(drug_name, drug_category, calculation_type, default_weight_type, standard_dose_value, standard_dose_unit, max_dose_cap, max_bsa_cap, max_gfr_cap) 
VALUES
('VINCRISTINE', 'CHEMOTHERAPY', 'BSA', 'ACTUAL', 1.40, 'mg/m2', 2.00, NULL, NULL),
('CARBOPLATIN', 'CHEMOTHERAPY', 'CALVERT_FORMULA', 'ACTUAL', 5.00, 'Target AUC', NULL, NULL, 125),
('BLEOMYCIN', 'CHEMOTHERAPY', 'FIXED_DOSE', 'ACTUAL', 30.00, 'units', NULL, NULL, NULL),
('CISPLATIN', 'CHEMOTHERAPY', 'BSA', 'ACTUAL', 75.00, 'mg/m2', NULL, NULL, NULL),
('TRASTUZUMAB', 'TARGETED_THERAPY', 'WEIGHT_BASED', 'ACTUAL', 6.00, 'mg/kg', NULL, NULL, NULL),
('PEMBROLIZUMAB', 'IMMUNOTHERAPY', 'FIXED_DOSE', 'ACTUAL', 200.00, 'mg', NULL, NULL, NULL)
ON DUPLICATE KEY UPDATE 
drug_category=VALUES(drug_category),
calculation_type=VALUES(calculation_type),
default_weight_type=VALUES(default_weight_type),
